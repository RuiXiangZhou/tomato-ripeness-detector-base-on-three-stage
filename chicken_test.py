...
def parser_get():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='tomato3class.pt', help='model.pt path(s)')
    ...
    for i in range (row):
        ...
        try:
            ...
            if label[i][5]==1:
                ...
                cv2.putText(frame, 'muti-ripe', (x, y-2), 0, 1 / 3, color_array[5], thickness=1, lineType=cv2.LINE_AA)
